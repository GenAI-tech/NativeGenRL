...
def sde_step_with_logprob(
    ...
    dt = sigma - sigma_prev  # >0

    std_dev_t = torch.sqrt(sigma / (1 - torch.where(sigma == 1, sigma_max, sigma)))*noise_level
    
    # our sde
    prev_sample_mean = sample*(1+std_dev_t**2/(2*sigma)*dt)+model_output*(1+std_dev_t**2*(1-sigma)/(2*sigma))*dt # model_output is noise to clean
    ...
    if prev_sample is None:
        ...
        # all -dt to dt: https://github.com/yifan123/flow_grpo/issues/32
